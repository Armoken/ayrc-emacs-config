...
** [[https://github.com/cosmicexplorer/helm-rg][Ripgrep]]                                                                                   :hotkeys:
...
** [[https://emacs-helm.github.io/helm/][Helm]]                                                                                  :ui:hotkeys:
...
** Layout switching                                                                        :hotkeys:
   ...
   #+END_SRC
** Movement between windows with M-arrow-keys M-arrow-keys (except org-mode)               :hotkeys:
    #+BEGIN_SRC emacs-lisp
...
** Goto to line with specific number                                                       :hotkeys:
  #+BEGIN_SRC emacs-lisp
