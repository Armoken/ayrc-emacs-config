     ...
     #+BEGIN_SRC emacs-lisp :tangle yes :noweb true
       (use-package doom-modeline
           ...
           (doom-modeline-def-segment ayrc/my-current-line
               ...
               (let* ((active (doom-modeline--active))
                      ...
                      (lines-only (concat "%l/" (int-to-string (count-lines (point-min) (point-max)))))
                      (lines-and-columns (concat "%l/" (int-to-string (count-lines (point-min) (point-max))) ":%c"))
                      (lines-and-columns-as-one (concat "%l/" (int-to-string (count-lines (point-min) (point-max))) ":%C"))
                      (lc '(line-number-mode
                            (column-number-mode
                             (doom-modeline-column-zero-based lines-and-columns lines-and-columns-as-one)
                             lines-only)
       ...
       mouse-1: Display Line and Column Mode Menu"
           ...
           (doom-modeline-def-modeline 'ayrc/my-simple-line
               '(bar matches buffer-info remote-host ayrc/my-current-line parrot selection-info)
