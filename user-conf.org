...
* VEL custom configuration
  #+BEGIN_SRC emacs-lisp :tangle yes
    ...
    (defun typescript-run-npm-build ()
        "Run `npm run build` in TypeScript mode."
        (interactive)
        (compile "npm run build"))

    (add-hook 'typescript-mode-hook
              (lambda ()
                  (local-set-key (kbd "C-c b") 'typescript-run-npm-build)))
    ...
    (setq lsp-clients-typescript-server-install-dir "/Users/vel/coding/gfit/node_modules/typescript/lib")
