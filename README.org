...
*** TODO [[https://github.com/Bad-ptr/persp-mode.el][persp-mode.el]]
    Package provides multiple named workspaces (or "perspectives") in Emacs,
    similar to multiple desktops in window managers like Awesome and XMonad,
    and Spaces on the Mac.
...
**** TODO [[https://github.com/Bad-ptr/persp-mode-projectile-bridge.el][Projectile bridge]]
...
** TODO [[https://github.com/manateelazycat/sdcv][sdcv]]
...
** Open current file in default external program                               :hotkeys:interactive:
   ...
   #+begin_src emacs-lisp :tangle yes
     (global-set-key (kbd "C-c o") #'ayrc/open-with)
   #+end_src
...
** .dir-locals.el for Org root dir
   #+begin_src emacs-lisp :tangle no
     ((nil
       . ((eval
           . (let* ((notes-dir (let ((d (dir-locals-find-file ".")))
                 ...
                 (setq org-indent-indentation-per-level               1
                       ...
                       org-roam-find-index                            (concat roam-dir "/Index.org")
                       org-roam-db-location                           roam-dir
                       org-archive-location                           "Archives/%s_archive::")

                 (add-hook 'org-mode-hook #'org-roam-mode        nil t)
                 (add-hook 'org-mode-hook #'org-roam-bibtex-mode nil t)


                 (setq org-agenda-files (list (concat notes-dir "ToDo.org"))))))))
   #+end_src
...
** TODO Archive settings
   Integrate [[https://gist.github.com/edgimar/072d99d8650abe81a9fe7c8687c0c993/470f5f01ef408957f36772368b8adba07c439b05][archiving with ancestors]].
