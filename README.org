...
** [[https://github.com/jeffvalk/snap-indent][snap-indent]]
...
#+begin_src emacs-lisp :tangle no :noweb-ref hindent-usepkg
  (use-package hindent
      :straight t
      :defer t
...
#+begin_src emacs-lisp :tangle no :noweb-ref lsp-haskell-usepkg
  (straight-use-package
