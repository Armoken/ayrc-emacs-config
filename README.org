...
*** Prerequisites
**** System
#+NAME: lsp-system-prerequisites
#+CAPTION: System prerequisites for lsp package
- [[https://github.com/blahgeek/emacs-lsp-booster][emacs-lsp-booster]] :: Tool for improving lsp performance
...
#+begin_src emacs-lisp :tangle no :noweb-ref ccls-debug-support
  ...
  (ayrc/dap-remove-nth-first-templates 1)
    ...
    (dap-register-debug-template
     "USDK RenderingTests: LLDB::Run"
     (list :type "lldb-vscode"
           :cwd "/Users/vel/coding/advertyclient"
           :request "launch"
           :program "/Users/vel/coding/advertyclient/Src/usdk/projects/Darwin/tests/integration_tests/IntegrationTests.app/Contents/MacOS/IntegrationTests"
          :args (list "\[RenderingTests\]")
           :name "LLDB::Run"))

    (dap-register-debug-template
     "USDK DoubleUSDK_RenderingTests: LLDB::Run"
     (list :type "lldb-vscode"
           :cwd "/Users/vel/coding/advertyclient"
           :request "launch"
           :program "/Users/vel/coding/advertyclient/Src/usdk/projects/Darwin/tests/integration_tests/IntegrationTests.app/Contents/MacOS/IntegrationTests"
          :args (list "\[DoubleUSDK_RenderingTests\]")
           :name "LLDB::Run"))

    (dap-register-debug-template
     "USDK ReloadTests: LLDB::Run"
     (list :type "lldb-vscode"
           :cwd "/Users/vel/coding/advertyclient"
           :request "launch"
           :program "/Users/vel/coding/advertyclient/Src/usdk/projects/Darwin/tests/integration_tests/IntegrationTests.app/Contents/MacOS/IntegrationTests"
          :args (list "ReloadTests")
           :name "LLDB::Run"))
    ...
    (dap-register-debug-template
     ...
     (list :type "lldb-vscode"
           ...
           :request "launch"
           :program "/Users/vel/coding/advertyclient/Src/usdk/projects/Darwin/tests/integration_tests/IntegrationTests.app/Contents/MacOS/IntegrationTests"
          :args (list "NetworkTests")
           :name "LLDB::Run"))


    (dap-register-debug-template
     "USDK IntegrationTests: LLDB::Run"
     (list :type "lldb-vscode"
           :cwd "/Users/vel/coding/advertyclient"
           :request "launch"
           :program "/Users/vel/coding/advertyclient/Src/usdk/projects/Darwin/tests/integration_tests/IntegrationTests.app/Contents/MacOS/IntegrationTests"
    ...
    (dap-register-debug-template
     "USDK Unit tests VastTrackingTest: LLDB::Run"
     (list :type "lldb-vscode"
           :cwd "/Users/vel/coding/advertyclient"
           :request "launch"
           :program "/Users/vel/coding/advertyclient/Src/usdk/projects/Darwin/tests/unit_tests/UnitTests"
          :args (list "VastTrackingTest")

;;           :args (list "--section Failed\ Sign\ In")
           :name "LLDB::Run"))

    (dap-register-debug-template
     "USDK Unit tests USDK_API_Tests: LLDB::Run"
     (list :type "lldb-vscode"
           :cwd "/Users/vel/coding/advertyclient"
           :request "launch"
           :program "/Users/vel/coding/advertyclient/Src/usdk/projects/Darwin/tests/unit_tests/UnitTests"
          :args (list "USDK_API_Tests")
           :name "LLDB::Run"))
