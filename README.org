            ...
            . (let* ((notes-dir        (locate-dominating-file default-directory dir-locals-file))
                  ...
                  (setq fill-column                          100
                        ...
                        org-agenda-prefix-format             '((agenda . " %i %?-12t% s")
                                                               ...
                                                               (tags   . " %i")
                                                               (search . " %i"))
                        org-super-agenda-groups              '((:name "Lifestyle"
                                                                :tag "lifestyle")
                                                               (:name "Courses"
                                                                :tag "courses")
                                                               (:name "Reading"
...
** [[https://github.com/eyeinsky/org-anki][org-anki]]
Sync org notes to Anki via AnkiConnect

#+begin_src emacs-lisp :tangle no :noweb yes :noweb-ref org-anki-usepkg
...
#+begin_src emacs-lisp :tangle no :noweb-ref ccls-debug-support
  ...
  (ayrc/dap-remove-nth-first-templates 1)
    ...
    (dap-register-debug-template
     "USDK Integration Tests: LLDB::Run"
